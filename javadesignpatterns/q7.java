...
public class q7 {
    public static void main(String[] args) {
        ...
        Developer developer1 = new Developer("Manidhar", "C++");
        Developer developer2 = new Developer("jaffa", "java");

        Manager manager1 = new Manager("Arzoo", "Deputy");
        Manager manager2 = new Manager("Arjun Reddy", "Associate");
